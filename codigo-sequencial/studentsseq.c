...
int main(void)
{
    ...
    for (unsigned regiao = 0; regiao < total_regioes; regiao++)
    {
        ...
        unsigned idx_fim_reg = regiao * alunos_por_regiao + alunos_por_regiao - 1;
        ...
        unsigned *contagem_regiao = construir_contagem(notas, idx_inicio_reg, idx_fim_reg);
    ...
    unsigned *contagem_brasil = construir_contagem(notas, 0, total_final_notas - 1);
